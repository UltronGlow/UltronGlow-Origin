...
// Address represents the 20 byte address of an utg account.
...
// UnmarshalText parses a hash in hex syntax.
func (a *Address) UnmarshalText1(input []byte) error {
	return hexutil.UnmarshalFixedText1("Address", input, a[:])
}
