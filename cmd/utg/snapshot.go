...
var (
	snapshotCommand = cli.Command{
		...
		Subcommands: []cli.Command{
			{
				Name:      "prune-state",
				Usage:     "Prune stale utg state data based on the snapshot",
				ArgsUsage: "<root>",
				...
				Description: `
utg snapshot prune-state <state-root>
...
during the use of utg, please also specify it here for correct deletion. Otherwise
...
`,
			},
			{
				...
				Description: `
utg snapshot verify-state <state-root>
...
`,
			},
			{
				...
				Description: `
utg snapshot traverse-state <state-root>
...
`,
			},
			{
				...
				Description: `
utg snapshot traverse-rawstate <state-root>
...
`,
			...
			{
				Name:      "dump",
				Usage:     "Dump a specific block from storage (same as 'utg dump' but using snapshots)",
				...
				Description: `
This command is semantically equivalent to 'utg dump', but uses the snapshots
