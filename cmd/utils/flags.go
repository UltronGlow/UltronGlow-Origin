...
// This file is part of utg.
//
// utg is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
// the Free Software Foundation, either version 3 of the License, or
// (at your option) any later version.
//
// utg is distributed in the hope that it will be useful,
// but WITHOUT ANY WARRANTY; without even the implied warranty of
// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
// GNU General Public License for more details.
//
// You should have received a copy of the GNU General Public License
// along with utg. If not, see <http://www.gnu.org/licenses/>.

// Package utils contains internal helper functions for utg commands.
package utils
...
import (
	...
	"github.com/UltronGlow/UltronGlow-Origin/common/fdlimit"
	...
	"github.com/UltronGlow/UltronGlow-Origin/eth"
	"github.com/UltronGlow/UltronGlow-Origin/eth/downloader"
	"github.com/UltronGlow/UltronGlow-Origin/eth/ethconfig"
	"github.com/UltronGlow/UltronGlow-Origin/eth/gasprice"
	"github.com/UltronGlow/UltronGlow-Origin/eth/tracers"
	"github.com/UltronGlow/UltronGlow-Origin/ethdb"
	"github.com/UltronGlow/UltronGlow-Origin/ethstats"
	"github.com/UltronGlow/UltronGlow-Origin/graphql"
	"github.com/UltronGlow/UltronGlow-Origin/internal/ethapi"
	"github.com/UltronGlow/UltronGlow-Origin/internal/flags"
	...
	"github.com/UltronGlow/UltronGlow-Origin/metrics/exp"
	"github.com/UltronGlow/UltronGlow-Origin/metrics/influxdb"
	"github.com/UltronGlow/UltronGlow-Origin/miner"
	"github.com/UltronGlow/UltronGlow-Origin/node"
	"github.com/UltronGlow/UltronGlow-Origin/p2p"
	"github.com/UltronGlow/UltronGlow-Origin/p2p/enode"
	"github.com/UltronGlow/UltronGlow-Origin/p2p/nat"
	"github.com/UltronGlow/UltronGlow-Origin/p2p/netutil"
...
func MakeDataDir(ctx *cli.Context) string {
	if path := ctx.GlobalString(DataDirFlag.Name); path != "" {
		if ctx.GlobalBool(TestnetFlag.Name) {
			// Maintain compatibility with older utg configurations storing the
...
// for utg and returns half of the allowance to assign to the database.
...
func MakeAddress(ks *keystore.KeyStore, account string) (accounts.Account, error) {
	...
	log.Warn("Please use explicit addresses! (can search via `utg account list`)")
	log.Warn("-------------------------------------------------------------------")
...
// RegisterEthService adds an utg client to the stack.
...
func RegisterEthService(stack *node.Node, cfg *ethconfig.Config) (ethapi.Backend, *eth.Ethereum) {
	if cfg.SyncMode == downloader.LightSync {
		...
		if err != nil {
			Fatalf("Failed to register the utg service: %v", err)
		}
...
// RegisterEthStatsService configures the utg Stats daemon and adds it to
// the given node.
func RegisterEthStatsService(stack *node.Node, backend ethapi.Backend, url string) {
	if err := ethstats.New(stack, backend, backend.Engine(), url); err != nil {
		Fatalf("Failed to register the utg Stats service: %v", err)
	}
}
...
// new format.
//
// e.g. utg account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// utg --keystore /tmp/mykeystore --lightkdf account new
//
