...
// setting up a new or managing an existing utg private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your utg private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new utg network down to  |")
	...
	log.Info("Administering utg network", "name", w.network)
