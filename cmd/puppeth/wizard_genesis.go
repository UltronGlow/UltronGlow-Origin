...
// importGenesis imports a utg genesis spec into puppeth.
...
func (w *wizard) manageGenesis() {
	...
	case "2":
		...
		// Export the native genesis spec used by puppeth and utg
		...
		// Export the genesis spec used by Aleth (formerly C++ utg)
		...
		// Export the genesis spec used by Harmony (formerly utgJ)
