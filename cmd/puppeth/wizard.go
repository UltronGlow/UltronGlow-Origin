...
type wizard struct {
	...
	services map[string][]string   // utg services known to be running on servers
...
// converts it to an utg address. If an empty line is entered, the default
// value is returned.
