...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "utg.ipc", false, filepath.Join(os.TempDir(), "utg.ipc")},
		{"data", "utg.ipc", false, "data/utg.ipc"},
		{"data", "./utg.ipc", false, "./utg.ipc"},
		{"data", "/utg.ipc", false, "/utg.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "utg.ipc", true, `\\.\pipe\utg.ipc`},
		{"data", "utg.ipc", true, `\\.\pipe\utg.ipc`},
		{"data", `\\.\pipe\utg.ipc`, true, `\\.\pipe\utg.ipc`},
	}
