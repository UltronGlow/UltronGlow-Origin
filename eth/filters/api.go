...
// information related to the utg protocol such als blocks, transactions and logs.
...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(utg.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
// Same as utg.FilterQuery but with UnmarshalJSON() method.
type FilterCriteria utg.FilterQuery
...
func (api *PublicFilterAPI) NewFilter(crit FilterCriteria) (rpc.ID, error) {
	...
	logsSub, err := api.events.SubscribeLogs(utg.FilterQuery(crit), logs)
	if err != nil {
		return "", err
	}
