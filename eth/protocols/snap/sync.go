...
import (
	...
	"github.com/UltronGlow/UltronGlow-Origin/p2p/msgrate"
...
// Syncer is an utg account and storage trie syncer based on snapshots and
...
// NewSyncer creates a new snapshot syncer to download the utg state over the
// snap protocol.
