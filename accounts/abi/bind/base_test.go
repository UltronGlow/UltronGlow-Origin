...
func (mc *mockCaller) CallContract(ctx context.Context, call utg.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call utg.CallMsg) ([]byte, error) {
