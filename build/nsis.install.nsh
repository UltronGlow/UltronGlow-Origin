Name "utg ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/UltronGlow/UltronGlow-Origin/issues"
!define UPDATEURL "https://github.com/UltronGlow/UltronGlow-Origin/releases"
!define ABOUTURL "https://github.com/UltronGlow/UltronGlow-Origin#utg"
...
Section "utg" utg_IDX
  ...
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\utg.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\utg.exe" "attach"
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe"

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "utg incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "utg outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "utg UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "utg incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\utg.exe" "" "" "utg" 30303 "" "" ""
  SimpleFC::AdvAddRule "utg outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\utg.exe" "" "" "utg" "" 30303 "" ""
  SimpleFC::AdvAddRule "utg UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\utg.exe" "" "" "utg" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "utg_SOCKET" "R" "HKLM" "\\.\pipe\utg.ipc"
  ${EnvVarUpdate} $0 "utg_SOCKET" "A" "HKLM" "\\.\pipe\utg.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${utg_IDX}
    SectionGetSize ${utg_IDX} $0
