...
# 1. install utg for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for utg
# 5. create utg, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable utg_SOCKET
...
!define GROUPNAME "utg"
!define APPNAME "utg"
!define DESCRIPTION "Official Go implementation of the utg protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since utg is installed global
