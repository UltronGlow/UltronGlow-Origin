...
Please see [Releases](https://github.com/UltronGlow/UltronGlow-Origin/releases). We recommend using the [most recently released version](https://github.com/UltronGlow/UltronGlow-Origin/releases/latest).

## Audit reports

Audit reports are published in the `docs` folder: https://github.com/UltronGlow/UltronGlow-Origin/tree/master/docs/audits 

| Scope | Date | Report Link |
| ------- | ------- | ----------- |
| `utg` | 20170425 | [pdf](https://github.com/UltronGlow/UltronGlow-Origin/blob/master/docs/audits/2017-04-25_utg-audit_Truesec.pdf) |
| `clef` | 20180914 | [pdf](https://github.com/UltronGlow/UltronGlow-Origin/blob/master/docs/audits/2018-09-14_Clef-audit_NCC.pdf) |

## Reporting a Vulnerability

**Please do not file a public ticket** mentioning the vulnerability.

To find out how to disclose a vulnerability in utg visit [https://bounty.utg.org](https://bounty.utg.org) or email bounty@utg.org. Please read the [disclosure page](https://github.com/UltronGlow/UltronGlow-Origin/security/advisories?state=published) for more information about publically disclosed security vulnerabilities.

Use the built-in `utg version-check` feature to check whether the software is affected by any known vulnerability. This command will fetch the latest [`vulnerabilities.json`](https://utg.org/docs/vulnerabilities/vulnerabilities.json) file which contains known security vulnerabilities concerning `utg`, and cross-check the data against its own version number.
