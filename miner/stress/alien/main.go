...
// This file contains a miner stress test based on the alien consensus engine.
package main
...
func main() {
	...
	// Create a alien network based off of the Rinkeby config
...
// makeGenesis creates a custom alien genesis block based on some pre-defined
...
func makeSealer(genesis *core.Genesis) (*node.Node, *eth.Ethereum, error) {
	// Define the basic configurations for the utg node
	...
	// Start the node and configure a full utg node on it
