...
// Package types contains data types related to utg consensus.
package types
...
// Header represents a block header in the utg blockchain.
type Header struct {
...
// Block represents an entire block in the utg blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// EncodeRLP serializes b into the utg RLP block format.
