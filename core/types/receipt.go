...
type Receipt struct {
	...
	// Implementation fields: These fields are added by utg. when processing a transaction.
...
func (r *Receipt) DecodeRLP(s *rlp.Stream) error {
	...
	case kind == rlp.String:
		...
		r.Type = b[0]
		if r.Type == AccessListTxType || r.Type == DynamicFeeTxType || r.Type == MultiSignerTxType {
			var dec receiptRLP
