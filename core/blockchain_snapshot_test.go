...
// It can be used for testing that restart utg. normally.
...
// It can be used for testing that restart utg. after the crash.
...
// Tests a utg. restart with valid snapshot. Before the shutdown, all snapshot
...
// Tests a utg. was crashed and restarts with a broken snapshot. In this case the
...
// Tests a utg. was crashed and restarts with a broken snapshot. In this case
...
// Tests a utg. was running with snapshot enabled. Then restarts without
...
// Tests the utg. was running with snapshot enabled and resetHead is applied.
...
// Tests the utg. was running with a complete snapshot and then imports a few
