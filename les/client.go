...
// Package les implements the Light utg Subprotocol.
package les
...
import (
	...
	"github.com/UltronGlow/UltronGlow-Origin/core/bloombits"
	...
	"github.com/UltronGlow/UltronGlow-Origin/eth/filters"
	...
	"github.com/UltronGlow/UltronGlow-Origin/les/vflux"
	vfc "github.com/UltronGlow/UltronGlow-Origin/les/vflux/client"
	"github.com/UltronGlow/UltronGlow-Origin/light"
	...
	"github.com/UltronGlow/UltronGlow-Origin/p2p/enr"
...
func New(stack *node.Node, config *ethconfig.Config) (*Lightutg, error) {
...
func (s *Lightutg) VfluxRequest(n *enode.Node, reqs vflux.Requests) vflux.Replies {
	if !s.udpEnabled {
		return nil
	}
...
func (s *Lightutg) vfxVersion(n *enode.Node) uint {
	if n.Seq() == 0 {
		var err error
		if !s.udpEnabled {
			return 0
...
func (s *Lightutg) prenegQuery(n *enode.Node) int {
	if s.vfxVersion(n) < 1 {
...
// APIs returns the collection of RPC services the utg package offers.
// NOTE, some of these services probably need to be moved to somewhere else.
func (s *Lightutg) APIs() []rpc.API {
...
func (s *Lightutg) ResetWithGenesisBlock(gb *types.Block) {
	s.blockchain.ResetWithGenesisBlock(gb)
}

func (s *Lightutg) BlockChain() *light.LightChain      { return s.blockchain }
func (s *Lightutg) TxPool() *light.TxPool              { return s.txPool }
func (s *Lightutg) Engine() consensus.Engine           { return s.engine }
func (s *Lightutg) LesVersion() int                    { return int(ClientProtocolVersions[0]) }
func (s *Lightutg) Downloader() *downloader.Downloader { return s.handler.downloader }
func (s *Lightutg) EventMux() *event.TypeMux           { return s.eventMux }

// Protocols returns all the currently configured network protocols to start.
func (s *Lightutg) Protocols() []p2p.Protocol {
...
// light utg protocol implementation.
func (s *Lightutg) Start() error {
