...
import (
	...
	"github.com/UltronGlow/UltronGlow-Origin/p2p/simulations"
	"github.com/UltronGlow/UltronGlow-Origin/p2p/simulations/adapters"
...
func newLesServerService(ctx *adapters.ServiceContext, stack *node.Node) (node.Lifecycle, error) {
	...
	utg, err := eth.New(stack, &config)
	if err != nil {
		return nil, err
	}
	_, err = NewLesServer(stack, utg, &config)
	if err != nil {
		return nil, err
	}
	return utg, nil
