...
import (
	...
	"github.com/UltronGlow/UltronGlow-Origin/internal/jsre"
	"github.com/UltronGlow/UltronGlow-Origin/internal/jsre/deps"
	"github.com/UltronGlow/UltronGlow-Origin/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client         // RPC client to execute utg requests through
...
// Welcome show summary of current utg instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the utg JavaScript console!\n\n"

	// Print some generic utg metadata
