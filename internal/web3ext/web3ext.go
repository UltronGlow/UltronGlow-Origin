...
// package web3ext contains utg specific web3.js extensions.
package web3ext
...
web3._extend({
	...
	methods: [
        ...
        new web3._extend.Method({
			name: 'getSnapshotSignerAtNumber',
			call: 'alien_getSnapshotSignerAtNumber',
			params: 1
		}),
        new web3._extend.Method({
			name: 'getSnapshotReleaseAtNumber',
			call: 'alien_getSnapshotReleaseAtNumber',
			params: 2
		}),
        new web3._extend.Method({
			name: 'getSnapshotFlowAtNumber',
			call: 'alien_getSnapshotFlowAtNumber',
			params: 1
		}),
        new web3._extend.Method({
			name: 'getSnapshotFlowMinerAtNumber',
			call: 'alien_getSnapshotFlowMinerAtNumber',
			params: 1
		}),
        new web3._extend.Method({
			name: 'getSnapshotFlowReportAtNumber',
...
web3._extend({
	...
	methods: [
        ...
        new web3._extend.Method({
			name: 'getBlockByNumber2',
			call: 'eth_getBlockByNumber2',
			params: 2,
			inputFormatter: [web3._extend.formatters.inputBlockNumberFormatter, function (val) { return !!val; }]
		}),
		new web3._extend.Method({
