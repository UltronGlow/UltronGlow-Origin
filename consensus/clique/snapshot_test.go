...
// mapped from textual names used in the tests below to actual utg private
...
// address retrieves the utg address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the utg address
