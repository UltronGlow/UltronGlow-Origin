...
// all blocks' seal as valid, though they still have to conform to the utg
// consensus rules.
...
// still have to conform to the utg consensus rules.
...
// they still have to conform to the utg consensus rules.
